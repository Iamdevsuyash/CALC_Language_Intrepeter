...
public class Parser {
    private final List<Token> tokens; // List of tokens generated by tokenizer
    ...
    private Expression parseExpression() {
        ...
        while (check(Token.Type.PLUS) || check(Token.Type.MINUS) || check(Token.Type.GT) || check(Token.Type.LT)
                || check(Token.Type.EQ)) {
